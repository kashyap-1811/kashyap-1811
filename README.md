...
|----------|--------------|------|
| 🔹 [**Auto-Stock**](https://github.com/kashyap-1811/StockTrading-App) | Real-time stock trading simulator using **MERN**, **WebSockets**, **AWS**, and **Razorpay** | ![React](https://img.shields.io/badge/React-blue) ![Node.js](https://img.shields.io/badge/Node.js-green) ![MongoDB](https://img.shields.io/badge/MongoDB-darkgreen) |
| 🔹 [**Bank System**](https://github.com/kashyap-1811/Sem-IV_JT) | Banking backend with **Spring Boot**, **Hibernate**, and **MySQL** | ![Java](https://img.shields.io/badge/Java-orange) ![SpringBoot](https://img.shields.io/badge/SpringBoot-green) |
| 🔹 [**AIHub**](https://github.com/kashyap-1811/AIHub) | Multi-AI .NET Core platform with custom API key integration | ![.NET](https://img.shields.io/badge/.NET-purple) ![React](https://img.shields.io/badge/React-blue) |
| 🔹 [**Eventify**](https://github.com/kashyap-1811/Sem-IV_Django) | QR-based event registration app with **Django** & **SMTP** | ![Django](https://img.shields.io/badge/Django-darkgreen) |
| 🔹 [**Holiday Hotels**](https://github.com/kashyap-1811/AirBnb-Replica) | Airbnb-like listing site built on **MERN**, with image uploads & authentication | ![MongoDB](https://img.shields.io/badge/MongoDB-green) ![Express](https://img.shields.io/badge/Express-black) |
| 🔹 [**StoreMore**](https://github.com/kashyap-1811/StoreMore) | Flutter-based mobile inventory management system | ![Flutter](https://img.shields.io/badge/Flutter-blue) |
